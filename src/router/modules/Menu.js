export default [
  {
    ...
    component: () =>
      import(/* webpackChunkName: "Menu1" */ "@/views/Menu/Menu1"),
    children: [],
  },
  {
    path: "menu2",
    ...
    children: [
      {
        ...
        component: () =>
          import(/* webpackChunkName: "Menu21" */ "@/views/Menu/Menu2/Menu21"),
        children: [],
      },
      {
        path: "menu22",
        ...
        component: () =>
          import(/* webpackChunkName: "Menu22" */ "@/views/Menu/Menu2/Menu22"),
        children: [],
      },
    ],
  },
